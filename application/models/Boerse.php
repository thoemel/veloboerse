...
class Boerse extends CI_Model {
	...
	/**
	 * Gibt eine Börsen-Instanz zurück, falls eine Börse offen ist. Falls nicht NULL.
	 * Falls mehrere offen sind (was nicht vorkommen sollte), wird die mit dem spätesten Datum gewählt.
	 *
	 * @return NULL|Boerse
	 */
	public static function aktuelle()
	{
	    $CI =& get_instance();
